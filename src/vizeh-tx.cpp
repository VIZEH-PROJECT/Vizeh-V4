...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("vizeh Core vizeh-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vizeh-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vizeh transaction") + "\n" +
                               "  vizeh-tx [options] -create [commands]   " + _("Create hex-encoded vizeh transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vizeh transaction
