...
In order to support loading of multiple wallets in vizeh-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vizeh.cpp.
...
Changes to vizeh.cpp
----------------------
vizeh.cpp is the entry point into vizeh-qt, and as such, will require some minor modifications to provide hooks for
