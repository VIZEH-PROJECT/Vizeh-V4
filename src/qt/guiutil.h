...
/** Utility functions used by the vizeh Qt UI.
 */
namespace GUIUtil
{
...
// Render vizeh addresses in monospace font
...
// Parse "vizeh:" URI into recipient object, return true on successful parsing
