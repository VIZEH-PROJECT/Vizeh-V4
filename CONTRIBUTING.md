Contributing to vizeh Core
============================

The vizeh Core project operates an open contributor model where anyone is
...
The following applies to code changes to the vizeh Core project, and is not to be
confused with overall vizeh Network Protocol consensus changes.

Whether a pull request is merged into vizeh Core rests with the project merge
...
Patches that change vizeh consensus rules are considerably more involved than
...
Where a patch set proposes to change the vizeh consensus, it must have been
...
The project leader is the release manager for each vizeh Core release.
